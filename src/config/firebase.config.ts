  ...
  private initializeFirebase() {
    if (!admin.apps.length) {
      const serviceAccount = {
        ...
        client_email: 'firebase-adminsdk-vb6z0@siscom-hris.iam.gserviceaccount.com',
        client_id: '102876094110911628432',
        auth_uri: 'https://accounts.google.com/o/oauth2/auth',
        token_uri: 'https://oauth2.googleapis.com/token',
        auth_provider_x509_cert_url: 'https://www.googleapis.com/oauth2/v1/certs',
        client_x509_cert_url: 'https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-vb6z0%40siscom-hris.iam.gserviceaccount.com',
